                ...
                VStack(alignment: .leading, spacing: 16) {
                    HStack(spacing: 10) {
                        ...
                        VStack(alignment: .leading, spacing: 2) {
                            Text((self.asr.isAsrReady || self.asr.modelsExistOnDisk) ? "Getting Started" : "Welcome to Speech2Write")
                                .font(self.theme.typography.title)
                            Text("Talk anywhere. Speech2Write types for you.")
                            ...
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                SetupStepView(
                                    ...
                                    description: self.asr.micStatus == .authorized
                                        ? "Speech2Write has access to your microphone"
                                        : "Allow Speech2Write to access your microphone for voice input",
                                ...
                                SetupStepView(
                                    ...
                                    description: self.isAIEnhancementReady
                                        ...
                                        : "Set up AI text enhancement with Apple Intelligence, on-device",
...
struct OnboardingFlowView: View {
    ...
    private enum Step: Int, CaseIterable {
        ...
        var title: String {
            ...
            case .vocabulary:
                return "Choose Vocabulary"
            case .permissions:
                return "Enable Access"
            case .aiEnhancement:
                return "Set Up AI Enhancement"
            case .playground:
                return "Try Speech2Write"
            }
        }
        ...
        var subtitle: String {
            switch self {
            case .landing:
                return "Talk anywhere. Speech2Write types for you."
            case .language:
                return "Pick the language you speak most."
            case .voiceModel:
                return "Choose the best local engine for your language."
            case .vocabulary:
                return "Optional: improve recognition for the fields you work in."
            case .permissions:
                return "Allow Speech2Write to listen and type into other apps."
            case .aiEnhancement:
            ...
            ZStack {
                VStack(alignment: .center, spacing: self.theme.metrics.onboardingSurface.landing.sectionSpacing) {
                    FluidOnboardingLandingHero(
                        ...
                        firstDetail: "Private, on-device dictation from CPA Automation.",
                        secondDetail: "Invented by Ray Sang · cpaautomation.ai"
                    ) {
                    ...
                    ScrollView(.vertical, showsIndicators: self.isShowingOtherModelRoutes) {
                        VStack(spacing: 0) {
                            ...
                            if self.selectedOnboardingLanguage.id == "en" {
                                Text("Dictating in another language? Choose Apple Speech.")
                                    .font(.system(size: 12, weight: .medium))
    ...
    private var vocabularyStep: some View {
        OnboardingVocabularyStepView(
            selectedPresetIDs: Binding(
                get: { self.settings.enabledVocabularyPresetIDs },
                set: { self.settings.enabledVocabularyPresetIDs = $0 }
            ),
            ...
            self.cinematicFooter(
                continueTitle: "Continue",
                canContinue: true,
                continueAction: self.handlePrimaryAction,
                skipTitle: "None for Now",
                canSkip: true,
                skipAction: self.goNext
            )
        }
    }
                            ...
                            VStack(spacing: 14) {
                                self.permissionRow(
                                    ...
                                    subtitle: self.isMicrophoneReady
                                        ? "Speech2Write can hear your dictation."
                                        : "Speech2Write needs the microphone to hear your dictation. Your voice is transcribed on-device — nothing leaves your Mac.",
                                ...
                                if !self.isMicrophoneReady || !self.isAccessibilityReady {
                                    Text("Already enabled it? Speech2Write will pick it up in a moment.")
                                        .font(.system(size: 12, weight: .medium))
                                        .foregroundStyle(Color.white.opacity(0.42))
                                        .padding(.top, 2)
                                }
    ...
    private func onboardingRouteCard(
        ...
        return VStack(alignment: .leading, spacing: 10) {
            ...
            HStack(spacing: 10) {
                ...
                Text(model.languageRowLabel)
                    .font(self.theme.typography.bodySmallStrong)
                    .foregroundStyle(Color.white.opacity(0.62))

                Spacer()

                Text(model.languageRowValue)
                    .font(self.theme.typography.bodySmallStrong)
                    .foregroundStyle(.white)
                    .lineLimit(1)
